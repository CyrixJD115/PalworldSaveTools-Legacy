...
| **Linux** | `PalworldSaveTools-*-linux.AppImage` |最新のディストリビューション |
...
> **Linux:** ファイルを実行可能としてマークする必要がある場合があります: `chmod +x PalworldSaveTools-*-linux.AppImage`
...
- **Linux:** `chmod +x PalworldSaveTools-*-linux.AppImage` を実行可能としてマークします。
...
- **GitHub 問題:** [Report a bug](https://github.com/CyrixJD115/PalworldSaveTools-Legacy/issues)
